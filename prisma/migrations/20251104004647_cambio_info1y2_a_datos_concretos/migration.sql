/*
  ...
  - You are about to drop the column `info1` on the `Exercise` table. All the data in the column will be lost.
  - You are about to drop the column `info2` on the `Exercise` table. All the data in the column will be lost.
