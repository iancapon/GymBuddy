PARA HACER:
+ JSON WEB TOKEN (JWT)(BACKENDO)

+ EXPO SECURE STORE (FRONTENDO)

+ FLOW:
	VOS TE LOGUEAS, VERIFICAS QUE EXISTA EN BACKENDO
	TE DEVUELVE EL TOKEN GENERADO POR EL JWT.
	Y, SE GUARDA EN EL FRONT CON EL SECURE STORE FULL ANASHE.

	AL ABRIR LA APP SECURE STORE GETTEA DEL DISPOSITIVO DEL TOKEN GUARDADO
